...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            defaultSrc: ["'none'"],
            imgSrc: ["'self'", "https://asdfasdfasfasdfdasfwdasdi.onrender.com/", "data:", "https://cdn.discordapp.com", "https://images-ext-1.discordapp.net", "https://media.discordapp.net/attachments/", "https://media.discordapp.net/", "/images/"],
            connectSrc: ["'self'", "https://asdfasdfasfasdfdasfwdasdi.onrender.com/", "https://asdfasdfasfasdfdasfwdasdi.onrender.com"],
            scriptSrc: ["'self'", "https://asdfasdfasfasdfdasfwdasdi.onrender.com/"],
            styleSrc: ["'self'", (req, res) => `'nonce-${res.locals.nonce}'`, "https://asdfasdfasfasdfdasfwdasdi.onrender.com"],
        },
    },
}));
